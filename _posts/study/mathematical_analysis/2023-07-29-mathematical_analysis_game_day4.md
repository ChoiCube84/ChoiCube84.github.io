...
확장된 실수는 정렬된 집합을 형성합니다: 네, 그렇습니다. 집합은 완전히 정렬되어 있으므로 두 요소를 비교할 수 있습니다.

확장된 실수는 필드를 형성합니다: 아니요, 그렇지 않습니다. 무한의 곱셈 역을 구하는 것과 같은 특정 연산은 시스템 내에서 불가능합니다.

확장 실수는 덧셈 및 곱셈과 순서의 호환성을 충족합니다: 부분적으로만. 양수 및 음수 무한대와 관련된 많은 연산이 예상대로 작동하지만, 몇 가지 예외가 있습니다. 예를 들어 0과 무한의 곱 또는 무한에서 무한의 뺄셈은 정의되지 않아 이러한 연산과의 순서 호환성을 깨뜨리는 경우가 있습니다.

확장된 실수에는 최소 상한 속성(LUBP)이 있습니다: 네, 그렇습니다. 상한이 있는 확장 실수의 비어 있지 않은 부분집합은 확장 실수 시스템에서도 최소 상한을 갖습니다.
