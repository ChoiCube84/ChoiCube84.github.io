...
1. 다언어 지원
    ...
    <img src="/img/posts/2023/July/13/multiple_languages.jpg" width="100%" height="100%" alt="다언어 지원">
...
2. 검색 기능
    ...
    <img src="/img/posts/2023/July/13/search.png" width="100%" height="100%" alt="검색 기능">

    설명할 필요도 없이 중요한 기능이다. 이 페이스대로 내가 열심히 글을 쓰게 된다면, 앞으로 엄청나게 많은 글들이 생성될 것이다. 이런 글들중 원하는 글을 찾아보려면 당연히 검색 기능이 필요할 것이다.

3. 광고

    <img src="/img/posts/2023/July/13/ads.png" width="100%" height="100%" alt="광고">
