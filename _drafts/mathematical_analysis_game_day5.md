...
정의 1.24와 같이 복소수를 정의하게 되면, 그런 복소수들을 모두 모아놓은 집합은 field를 형성하는 다는 것이 이 정리에서 말하고자 하는 내용이다. 증명은 다음과 같다.

<details>
<summary>증명</summary>

복소수들의 집합이 field를 구성한다는 것을 증명하기 위해서는, field의 정의가 무엇이었는지 다시 떠올려볼 필요가 있다.
